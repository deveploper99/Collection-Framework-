...
//        }
    ...
    private static void listIterator(){
        ...
        ListIterator<String> iyhg = names.listIterator();
        while (iyhg.hasNext()){
            String name1 = iyhg.next();
            int index = iyhg.previousIndex();
            if (name1.equals("liya")){
...
//        while (iyhg.hasPrevious()){
//            System.out.println(iyhg.previous());
//        }
    }
